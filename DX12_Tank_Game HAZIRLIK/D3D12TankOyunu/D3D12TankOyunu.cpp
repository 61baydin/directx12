...
void OnUpdate()
{
	...
	/////////////////////////////// HAZIRLIK 3: TANK DUVARDAN GEÇMEDEN İLERİ GERİ HAREKET ///////////////////////////////////
	if (keyboardState[DIK_W] & 0x80)
	{
		...
		bool move = true;
		float uzaklik = IntersectTriangle(Ro, Rd, vertices_Walls, vertexCount_Walls, XMMatrixIdentity());
		if (uzaklik < 9.5 && uzaklik > 0.0) {
			move = false;
		}
		if (move) {
	...
	//////////////////////// HAZIRLIK 1: ZOOM YAPMA ////////////////////////////////
	if (!(mouseCurrState.rgbButtons[1] & 0x80))			// Right Button is UP (for Zoom out)
	{

		g_Projection = XMMatrixPerspectiveFovLH(XM_PIDIV4, 1280 / (FLOAT)720, 0.01f, 1000.0f);  // 690. satırdan
		m_constantBufferData.mProjection = XMMatrixTranspose(g_Projection);						//  694. satırdan
	}

	if (mouseCurrState.rgbButtons[1] & 0x80)			// Right Button is PRESSED (for Zoom in)
	{
		g_Projection = XMMatrixPerspectiveFovLH(XM_PI / 8, 1280 / (FLOAT)720, 0.01f, 1000.0f);	// PI/8 Zoom in
		m_constantBufferData.mProjection = XMMatrixTranspose(g_Projection);
	}
	/////////////////////////////////////////////////////////////////////////////////
	...
	if (FireTankMissile)
	{
		...
		////////////////////////// HAZIRLIK 5: MERMİ DOĞRULTUSU DEĞİŞMİCEK//////////////////////
	...
	if (TraceTankMissile)
	{
		...
		//////////////////////// HAZIRLIK 4: MERMİNİN DÖNEREK İLERLEMESİ //////////////////////
		XMMATRIX mRotateMissile = XMMatrixRotationZ(XM_PI / 8);
	...
	if (intersections.size() > 0)
	{
		...
		/////////////////// HAZIRLIK 2: MERMİ DUVARI GEÇMESİN /////////////////
